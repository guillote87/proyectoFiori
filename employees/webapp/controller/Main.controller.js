sap.ui.define([
    ...
    return Controller.extend("employees.controller.Main", {
        ...
        onInit: function () {
            ...
            //Otra opcion de como suscribir directamente en suscribe sin crear funcion
            this._bus.subscribe("incidence", "onDeleteIncidence", function (channelId, eventId, data) {
                ...
                this.getView().getModel("incidenceModel").remove("/IncidentsSet(IncidenceId='" + data.IncidenceId +
                    ...
                    error: function (e) {
                        sap.m.MessageToast.show(oResourceBundle.getText("odataDeleteFail"))
                    }.bind(this)
                })
            }, this)
        ...
        onSaveOdataIncidence: function (channelId, eventId, data) {
            ...
            if (typeof incidenceModel[data.incidenceRow].IncidenceId == 'undefined') {
                ...
                this.getView().getModel("incidenceModel").create("/IncidentsSet", body, {
                    ...
                    error: function (e) {
                        sap.m.MessageToast.show(oResourceBundle.getText("odataSaveFail"))
                    }.bind(this)
                })
                ...
                this.getView().getModel("incidenceModel").update("/IncidentsSet(IncidenceId='" + incidenceModel[data.incidenceRow].IncidenceId +
                    ...
                    error: function (e) {
                        sap.m.MessageToast.show(oResourceBundle.getText("odataUpdateFail"))
                    }.bind(this)
                })
            }
            else {
            ...
            this.getView().getModel("incidenceModel").read("/IncidentsSet", {
                ...
                success: function (data) {
                    ...
                    for (var incidence in data.results) {
                        ...
                        //Le pasamos none para el valueState a los campos ya existentes
                        data.results[incidence]._ValidateDate = true
                        data.results[incidence].EnabledSave = false
                        

                        var newIncidence = sap.ui.xmlfragment("employees.fragment.NewIncidence", this._detailEmployeeView.getController())
